...
import com.abharana.services.domain.model.UserProfile.UserStatus;
import com.abharana.services.domain.model.repositories.IUserProfileRepository;
import com.abharana.services.web.security.RESTUser;
import com.abharana.services.web.security.UserNotFoundException;
...
public class UserSecurityServiceImpl implements IUserSecurityService {
     ...
     * (non-Javadoc)
     * 
     * @see com.abharana.services.web.security.services.IUserSecurityService#
