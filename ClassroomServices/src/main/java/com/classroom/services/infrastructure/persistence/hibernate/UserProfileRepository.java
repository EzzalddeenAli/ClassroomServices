...
import com.classroom.services.domain.model.repositories.criteria.UserSearchCriteria;
...
public class UserProfileRepository extends
     ...
     * (non-Javadoc)
     * 
     * @see com.classroom.services.domain.repositories.IUserProfileRepository#
     ...
     * 
     * @see
     * com.kony.es.repositories.IUserRepository#searchUsers(com.classroom.services
     ...
     * (non-Javadoc)
     * 
     * @see com.classroom.services.domain.repositories.IUserProfileRepository#flush()
     */
    public void flush() {
