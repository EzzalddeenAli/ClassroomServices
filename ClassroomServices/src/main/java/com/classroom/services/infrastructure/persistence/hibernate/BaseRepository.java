...
public abstract class BaseRepository<T extends AbstractEntity, E extends BaseSearchCriteria>
     ...
     * 
     * @see
     * com.kony.es.repositories.IBaseRepository#save(com.classroom.services.domain
     ...
     * 
     * @see
     * com.kony.es.repositories.IBaseRepository#remove(com.classroom.services.domain
     * .model .AbstractEntity)
     */
     ...
     * 
     * @see
     * com.kony.es.repositories.IBaseRepository#refresh(com.classroom.services.domain
     * .model .AbstractEntity)
     */
