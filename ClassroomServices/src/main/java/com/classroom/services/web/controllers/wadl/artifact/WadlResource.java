...
public class WadlResource {
    ...
    @XmlElements({ @XmlElement(name = "method", type = WadlMethod.class),
     ...
     * 
     * @return the param {@link WadlParam }
     */
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the methodOrResource property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * Objects of the following type(s) are allowed in the list
     * 
     * @return the method or resource {@link WadlMethod }
     *         {@link com.classroom.services.web.controllers.wadl.artifact.WadlResource }
     */
